# Generated by Django 3.0.7 on 2020-06-16 17:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('color_name', models.CharField(choices=[('RD', 'red'), ('OR', 'orange'), ('YW', 'yellow'), ('GN', 'green'), ('BL', 'blue'), ('IN', 'indigo'), ('VT', 'violet'), ('WH', 'white'), ('BK', 'black')], default='WHß', max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='ShoeType',
